...
export default function IndirectObjectExercise() {
  const [, params] = useRoute("/practice/exercises/indirect-object/:page");
  const [selectedPage, setSelectedPage] = useState<PageType | null>(
    (params?.page as PageType) || null
  );

  const backPath = "/practice/exercises/indirect-object";

  const handleSelectPage = (page: PageType) => {
    setSelectedPage(page);
    window.history.pushState({}, "", `/practice/exercises/indirect-object/${page}`);
  };

  const handleBack = () => {
    setSelectedPage(null);
    window.history.pushState({}, "", "/practice/exercises/indirect-object");
  };
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Indirect Object Practice</h1>
        ...
        {!selectedPage ? (
          ...
          <MultipleChoicePage 
            exercises={indirectObjectPage1} 
            pageNum="1" 
            instruction="Replace the indirect object in each sentence with the correct indirect object pronoun."
            backPath={backPath}
          />
        ) : selectedPage === "2" ? (
          <RewritePage 
            exercises={indirectObjectPage2} 
